    ...
    <div id="myBillingArea">
          ...
          if (!$orderQueryRes) {
            ...
            <div class="billing-header">
              <div class="d-flex justify-content-between">
                ...
                <h1 style="color: #007bff;">Quotation</h1>
              </div>
            </div>
      ...
      <br>
          ...
          <div class="billing-address">
              ...
              <p>- This quotation is valid for a period of 30 days from the date of issuance.<p>
              <p>- Any additional work or changes requested by the customer may result in revised pricing.<p>
              <p>- The customer may cancel or amend the quotation before acceptance without penalty.<p>
              <p>- Acceptance of this quotation constitutes agreement to these terms and conditions.<p>
            ...
            <div class="billing-address">
             ...
             <br>
              <br>
              <p>............................................</p>
              <p style="font-size: 16px;">(Customer's signature)</p>
            </div>
            <br>
            <br>
            <br>
...
<script>
  ...
  var modifiedInvoiceNo = invoiceNo.replace('INV', 'quotation');

      pdf.save(modifiedInvoiceNo + '.pdf');
    });
  }
</script>
