          ...
          if (!$orderQueryRes) {
            ...
            <div class="billing-header">
              <div class="d-flex justify-content-between">
                <div>
                  <h2>KSQ10 ENTERPRISE</h2>
                  <p>Workshop & Repair</p>
                </div>
                <h1 style="color: #007bff;">Receipt</h1>
              </div>
            </div>
...
<script>
  ...
  function downloadPDF(invoiceNo) {
    ...
    html2canvas(element, {
      scale: 1,  // Reduced scale to lower resolution
      useCORS: true
    }).then(canvas => {
      const imgData = canvas.toDataURL('image/jpeg', 0.75);  // Change to JPEG and apply compression
      ...
      var modifiedInvoiceNo = invoiceNo.replace('INV', 'receipt');
